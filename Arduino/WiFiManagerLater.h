...
bool WiFiManagerUser_Set_Value(byte ValueID, String Value) {
  ...
  switch (ValueID) {                                            //Note the numbers are shifted from what is in memory, 0 is the first user value
    ...
    case 3:   Path_A[0] = Value;                  return true;    break;
    case 4:   Path_A[1] = Value;                  return true;    break;
    case 5:   Path_A[2] = Value;                  return true;    break;
    case 6:   Path_A[3] = Value;                  return true;    break;
    case 7:   Json_A[0] = Value;                  return true;    break;
    case 8:   Json_A[1] = Value;                  return true;    break;
    case 9:   Json_A[2] = Value;                  return true;    break;
    case 10:  Json_A[3] = Value;                  return true;    break;
    case 11: {
    ...
    case 12:  Path_B[0] = Value;                  return true;    break;
    case 13:  Path_B[1] = Value;                  return true;    break;
    case 14:  Path_B[2] = Value;                  return true;    break;
    case 15:  Path_B[3] = Value;                  return true;    break;
    case 16:  Json_B[0] = Value;                  return true;    break;
    case 17:  Json_B[1] = Value;                  return true;    break;
    case 18:  Json_B[2] = Value;                  return true;    break;
    case 19:  Json_B[3] = Value;                  return true;    break;
    case 20: {
        byte Rotation = ConvertRotationToByte(Value);
        if (Rotation == UNK)                      return false; //Not set, Rotation is out of range
...
String WiFiManagerUser_Get_Value(byte ValueID, bool Safe, bool Convert) {
  ...
  switch (ValueID) {                                            //Note the numbers are shifted from what is in memory, 0 is the first user value
    ...
    case 3:   return Path_A[0];                   break;
    case 4:   return Path_A[1];                   break;
    case 5:   return Path_A[2];                   break;
    case 6:   return Path_A[3];                   break;
    case 7:   return Json_A[0];                   break;
    case 8:   return Json_A[1];                   break;
    case 9:   return Json_A[2];                   break;
    case 10:  return Json_A[3];                   break;
    case 11:  return ConvertRotationToString(RotationA); break;
    case 12:  return Path_B[0];                   break;
    case 13:  return Path_B[1];                   break;
    case 14:  return Path_B[2];                   break;
    case 15:  return Path_B[3];                   break;
    case 16:  return Json_B[0];                   break;
    case 17:  return Json_B[1];                   break;
    case 18:  return Json_B[2];                   break;
    case 19:  return Json_B[3];                   break;
    case 20:  return ConvertRotationToString(RotationB); break;
  }
  return "";
}
//===========================================================================
